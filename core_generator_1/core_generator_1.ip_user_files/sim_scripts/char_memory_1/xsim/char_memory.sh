...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L secureip -L xpm --snapshot char_memory xil_defaultlib.char_memory -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  char_memory -key {Behavioral:sim_1:Functional:char_memory} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb char_memory.wdb xsim.dir)
