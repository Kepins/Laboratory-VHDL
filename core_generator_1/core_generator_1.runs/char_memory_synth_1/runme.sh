...
HD_PWD='C:/Users/szkep/source/repos/Vivado/core_generator_1/core_generator_1.runs/char_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log char_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source char_memory.tcl
